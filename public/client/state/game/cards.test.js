...
describe('game - cards shuffling', () => {
  it('should return the whole deck', () => {
    ...
    expect(_.filter(cards, {value: 2, action: null}).length).to.equal(4)
    expect(_.filter(cards, {value: 3, action: null}).length).to.equal(4)
    expect(_.filter(cards, {value: -4, action: null}).length).to.equal(4)
    expect(_.filter(cards, {value: 5, action: null}).length).to.equal(4)
    expect(_.filter(cards, {value: 6, action: null}).length).to.equal(4)
    expect(_.filter(cards, {value: 8, action: null}).length).to.equal(4)
    expect(_.filter(cards, {value: 9, action: null}).length).to.equal(4)
    ...
    expect(_.filter(cards, {value: 12, action: null}).length).to.equal(4)
